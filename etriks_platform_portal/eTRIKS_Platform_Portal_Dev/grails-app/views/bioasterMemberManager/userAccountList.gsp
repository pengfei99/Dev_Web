...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <ul>
                <li><a class="list" href="${createLink(uri: '/bioasterMemberManager/')}">Back to the bioaster member manager </a></li>
                <li><a class="list" href="${createLink(uri: '/bioasterMemberManager/userMailListWithUserName')}"> bioaster member mail List </a></li>
            </ul>
        </div>
...
<div class="nav" role="navigation">
			<ul>
               ...
               <li><a class="list" href="${createLink(uri: '/bioasterMemberManager/userMailListWithUserName')}"> <g:message code="bioaster member mail List"/> </a></li>
			</ul>
		</div>
  <div class="body">
      <div id="mainText">
          <br>
          <br>
          There are ${userAccountTotal} registered user in Bioaster project LDAP server
          <br>
          <br>
      </div>
  <table>
