            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><label for="projectName">Project Name:</label>
                            </td>

                            <td valign="top">
                                <g:select name="projectName" from="${projectList}"  required="" value="" />
                            </td>
                        </tr>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <fieldset class="buttons">
                        ...
                        <g:actionSubmit class="save" action="createProjectGroupLdapEntry" value="submit"  />
                    </fieldset>
                </div>
            </div>
        </g:form>
