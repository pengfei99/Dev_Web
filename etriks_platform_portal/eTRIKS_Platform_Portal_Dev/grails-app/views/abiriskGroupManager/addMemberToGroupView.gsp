                        ...
                        <g:each in="${userList}" status="i" var="user">
                            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                <td>
                                    ...
                                    <g:link controller="abiriskMemberManager" action="showUserDetails" id="${user.key}">${user.key}</g:link></td>
                                <td>${user.value}</td>
                            </tr>
                        </g:each>
                        </tbody>
...
%{--
The body onLoad balise will be active when we load the page

<body onLoad="document.addMemberToGroup.reset()">
