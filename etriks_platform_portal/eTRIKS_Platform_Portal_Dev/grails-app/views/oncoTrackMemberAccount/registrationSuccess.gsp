...
<body>
    ...
    <div id="show-oncotrackMemberAccount" class="container">
        <div class="row">
                <h3>Your registration request has been sent to the validator  <a href="mailto:EVDSTUYF@its.jnj.com" target="_top">Emmanuel Van Der Stuyft</a>
                    and <a href="mailto:r.yildirimman@alacris.de" target="_top">Reha Yildirimman</a>. You will receive a confirmation email if your registration request is validated!!!</h3>
