...
<body>
   ...
   <div id="show-abiriskMemberAccount" class="container">
    <div class="row">
        <h3>Your registration request has been sent to the validator  <a href="mailto:njullian@eisbm.org" target="_top">Nathalie Jullian</a>
            and <a href="mailto:pierre@scicross.com" target="_top">Pierre Donnes</a>. You will receive a confirmation email if your registration request is validated!!!</h3>
