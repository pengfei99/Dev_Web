...
<title>eTRIKS end user space</title>
</head>
<body>
...
<div id="bodyText">
<h3> This page is reserved for the <span style="text-transform: uppercase ;color:red;font-weight:bold ">eTRIKS</span> project member only. Any chang you make in this page only affect your <span style="text-transform: uppercase ;color:red;font-weight:bold ">eTRIKS</span> platform account </h3>
