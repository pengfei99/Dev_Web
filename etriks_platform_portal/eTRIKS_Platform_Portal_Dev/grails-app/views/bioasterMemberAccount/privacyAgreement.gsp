...
The data controller is BioSci Consulting, Weg naar Geneuth 95, 3631, Maasmechelen, Belgium
</span>
<br>
<br>
...
<br>
Questions, comments and requests regarding this privacy policy are welcomed and should be addressed to collectivecreativity@biosciconsulting.com
  </p>

  </div>
           <br>
           <input type="checkbox" name="AgreeToMail" value=true>Yes, I'd like to receive mails from eTRIKS communinity
           <br>
           <br>
      </div>
      </div>
...
<div class="col-md-8 col-md-offset-1 text-center">
  <form  action="bioasterAccountCreate" method="get">
   ...
   <tr>
							...
							<td>
			<button type="button" onclick="alert('You have to agree the license to continue!')">Disagree</button>
