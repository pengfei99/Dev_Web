...
<html>
	...
	<body>
		<a href="#edit-etriksMemberAccount" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-etriksMemberAccount" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${etriksMemberAccountInstance?.version}" />
				<fieldset class="form">
