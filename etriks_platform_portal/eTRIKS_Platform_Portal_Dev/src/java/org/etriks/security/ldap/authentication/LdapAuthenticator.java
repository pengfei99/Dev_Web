...
public class LdapAuthenticator {
    ...
    public LdapAuthenticator(LdapServerConnectorConfig ldapConfig){
        ...
        conLdp=new LdapConnector(ldapConfig);
    ...
    public boolean checkAuthWithLdap(String uid, String password) {
        ...
        try {
            if (answer.hasMore()) {
                ...
                //Add the ldap serverName
                userRoles.add(ldapConfig.getLdapServerName());
                ...
                return false;
				     ...
				     *
				     */
            log.error("LDAP server check password throws naming exeception : "+e.toString());
