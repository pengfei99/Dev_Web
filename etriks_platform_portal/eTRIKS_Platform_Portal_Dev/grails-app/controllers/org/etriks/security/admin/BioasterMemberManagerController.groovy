...
class BioasterMemberManagerController {

    def projectName="bioaster";
    ...
    * */
    ...
    def userAccountList(){
       ...
       /* //Create an instance of userAccountManager
        def	UserAccountManager accReg = new UserAccountManager(bioasterLdap,"ou=Users,dc=etriks,dc=eu","ou=Users,dc=etriks,dc=eu");
        //get All users cn.
