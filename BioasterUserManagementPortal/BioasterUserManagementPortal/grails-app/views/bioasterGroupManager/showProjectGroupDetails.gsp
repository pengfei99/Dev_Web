            ...
            <div class="col-md-12">
                ...
                <div class="nav" role="navigation">
                    <ul>
                        ...
                        <li><a class="list" href="${createLink(uri: '/bioasterGroupManager/projectGroupList')}"> BIOASTER Project Group List </a></li>
                    </ul>
                </div>
            </div>
        </div>
...
%{--Group name row--}%
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <g:form  controller="bioasterGroupManager" action="deleteUserFromProjectGroup" method="get" name="deleteUserFromProjectGroup">
