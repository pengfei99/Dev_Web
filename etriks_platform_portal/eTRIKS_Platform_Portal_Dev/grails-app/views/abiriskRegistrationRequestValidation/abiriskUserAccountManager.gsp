...
<head>
    ...
    <title>Abirisk member registration request</title>
</head>
<body>
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <g:sortableColumn property="abiriskValidatorDecision" title="CZAR_validation"/>
    ...
    <g:each in="${abiriskMemberAccountInstanceList}" status="i" var="abiriskMemberAccountInstance">
        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
            ...
            <td>${fieldValue(bean: abiriskMemberAccountInstance, field: "abiriskValidatorDecision")}</td>
