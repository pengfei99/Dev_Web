...
<html>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                you can go to <a class="list" href="${createLink(uri: '/bioasterGroupManager/bioasterGroupList')}"> bioaster department group list  </a> to check the new group member information
            </div>
        </div>
        <br>
        <br>
