 ...
 */
public class OncoTrackLdapConnectorConfig implements LdapServerConnectorConfig {

    //set some connected information

    private	final static String INITIAL_CONTEXT_FACTORY="com.sun.jndi.ldap.LdapCtxFactory";
    private	final static String PROVIDER_URL="ldap://auth.oncotrack.etriks.org:389";
    ...
    private	final static String SECURITY_CREDENTIALS="LiuVZ60DFAd";
    ...
    private final static String LdapServerName="OncoTrack";
